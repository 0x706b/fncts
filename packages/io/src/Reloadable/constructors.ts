 ...
 */
export function auto<In, E, OutId, Out, Env>(
  layer: Layer<In, E, OutId>,
  tag: Tag<OutId, Out>,
 ...
 */
export function autoFromConfig<In, E, OutId, Out, Env>(
  layer: Layer<In, E, OutId>,
  tag: Tag<OutId, Out>,
  scheduleFromConfig: (env: Environment<In>) => Schedule<Env, any, any>,
  /** @tsplus auto */ reloadableTag: Tag<Reloadable<Out>, Reloadable<Out>>,
): Layer<In | Env, E, Reloadable<Out>> {
  return Layer.scoped(
    Do((Δ) => {
 ...
 */
export function manual<In, E, OutId, Out>(
  layer: Layer<In, E, OutId>,
  tag: Tag<OutId, Out>,
  /** @tsplus auto */ reloadableTag: Tag<Reloadable<Out>, Reloadable<Out>>,
