...
export class Sync<A> extends IO<unknown, never, A> {
...
export class UpdateRuntimeFlags extends IO<unknown, never, void> {
...
export class GenerateStackTrace extends IO<unknown, never, Trace> {
...
export class YieldNow extends IO<unknown, never, void> {
