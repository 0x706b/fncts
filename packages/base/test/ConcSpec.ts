import { check } from "@fncts/test/api";
import { deepEqualTo, every } from "@fncts/test/control/Assertion";
import { Gen } from "@fncts/test/control/Gen";

class ConcSpec extends DefaultRunnableSpec {
  spec = suite(
    "Conc",
    suite(
      "length",
