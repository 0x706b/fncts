...
export function modify<A, B>(f: (a: A) => readonly [B, A]) {
  return <EA, EB>(self: PFiberRef<EA, EB, A, A>): FIO<EA | EB, B> =>
    modify_(self, f);
}
/**
...
export function update<A>(f: (a: A) => A) {
  return <EA, EB>(fiberRef: PFiberRef<EA, EB, A, A>): FIO<EA | EB, void> =>
    update_(fiberRef, f);
}
/**
...
export function set<A>(a: A) {
  return <EA, EB>(fiberRef: PFiberRef<EA, EB, A, A>): FIO<EA, void> =>
    set_(fiberRef, a);
}
/**
...
export function getWith<B, R, E, C>(f: (b: B) => IO<R, E, C>) {
  return <EA, EB, A>(fiberRef: PFiberRef<EA, EB, A, B>): IO<R, EB | E, C> =>
    getWith_(fiberRef, f);
}
/**
...
export function dimapEither<A, B, EC, ED, C, D>(
  ...
  return <EA, EB>(
    ref: PFiberRef<EA, EB, A, B>
  ): PFiberRef<EA | EC, EB | ED, C, D> => dimapEither_(ref, f, g);
}
/**
 * @tsplus dataFirst dimap_
 */
export function dimap<A, B, C, D>(f: (inp: C) => A, g: (out: B) => D) {
  return <EA, EB>(ref: PFiberRef<EA, EB, A, B>): PFiberRef<EA, EB, C, D> =>
    dimap_(ref, f, g);
}
/**
...
export function dimapError<EA, EB, EC, ED>(
  ...
  return <A, B>(ref: PFiberRef<EA, EB, A, B>): PFiberRef<EC, ED, A, B> =>
    dimapError_(ref, f, g);
}
/**
...
export function contramapEither<A, EC, C>(f: (inp: C) => Either<EC, A>) {
  return <EA, EB, B>(
    ref: PFiberRef<EA, EB, A, B>
  ): PFiberRef<EA | EC, EB, C, B> => contramapEither_(ref, f);
}
/**
 * @tsplus dataFirst contramap_
 */
export function contramap<A, C>(f: (inp: C) => A) {
  return <EA, EB, B>(ref: PFiberRef<EA, EB, A, B>): PFiberRef<EA, EB, C, B> =>
    contramap_(ref, f);
}
/**
...
export function filterMap<B, C>(f: (b: B) => Maybe<C>) {
  return <EA, EB, A>(
    ref: PFiberRef<EA, EB, A, B>
  ): PFiberRef<EA, Maybe<EB>, A, C> => filterMap_(ref, f);
}
/**
...
export function filterInput<A>(p: Predicate<A>) {
  return <EA, EB, B>(
    ref: PFiberRef<EA, EB, A, B>
  ): PFiberRef<Maybe<EA>, EB, A, B> => filterInput_(ref, p);
}
/**
...
export function filterOutput<B>(p: Predicate<B>) {
  return <EA, EB, A>(
    ref: PFiberRef<EA, EB, A, B>
  ): PFiberRef<EA, Maybe<EB>, A, B> => filterOutput_(ref, p);
}
/**
...
export function mapEither<B, EC, C>(f: (out: B) => Either<EC, C>) {
  return <EA, EB, A>(
    ref: PFiberRef<EA, EB, A, B>
  ): PFiberRef<EA, EB | EC, A, C> => mapEither_(ref, f);
}
/**
 * @tsplus dataFirst map_
 */
export function map<B, C>(f: (out: B) => C) {
  return <EA, EB, A>(ref: PFiberRef<EA, EB, A, B>): PFiberRef<EA, EB, A, C> =>
    map_(ref, f);
}
// codegen:end
