...
export interface Monad<F extends HKT, FC = HKT.None>
...
export type MonadMin<F extends HKT, FC = HKT.None> = ApplicativeMin<F, FC> &
  ChainMin<F, FC>;

/**
 * @tsplus static fncts.MonadOps __call
 */
export function mkMonad<F extends HKT, FC = HKT.None>(
  F: MonadMin<F, FC>
): Monad<F, FC> {
