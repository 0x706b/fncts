...
export interface Semimonoidal<F extends HKT, C = HKT.None>
  extends HKT.Typeclass<F, C> {
...
export function mkSemimonoidal<F>(
  F: SemimonoidalMin<HKT.F<F>>
): Semimonoidal<HKT.F<F>> {
