 ...
 */
export interface FoldableWithIndex<F extends HKT, FC = HKT.None>
  extends Foldable<F, FC> {
...
export type FoldableWithIndexMin<F extends HKT, FC = HKT.None> = FoldableMin<
  F,
  FC
> & {
  readonly foldLeftWithIndex_: foldLeftWithIndex_<F, FC>;
