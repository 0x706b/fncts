import { Dictionary } from "../collection/immutable/Dictionary/definition";
import { Struct } from "../data/Object/definition";
...
function generateStyles() {
  ...
  const colorsBright: {
    ...
    ...b,
    [`bright${k.capitalize}`]: [c + ANSI_BRIGHT_OFFSET, r],
  }));
  ...
  const colorsBg: {
    ...
    ...b,
    [`bg${k.capitalize}`]: [c + ANSI_BACKGROUND_OFFSET, r + ANSI_BACKGROUND_OFFSET],
  }));
